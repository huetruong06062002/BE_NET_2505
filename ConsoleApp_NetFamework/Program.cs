...
namespace ConsoleApp_NetFamework
{
	public class Program
	{
		...
		static bool CheckValidateInput(string input)
		{
			...
			//Check XSS
			if (!ValidateData.CheckXSSInput(input))
			{
				return false;
			}
		...
		static void Main(string[] args)
		{
			...
			Console.WriteLine("ChieuDai maydell: {0}", maydell.ChieuDai + "\n");
			Console.WriteLine("ChieuRong maydell: {0}", maydell.ChieuRong + "\n");


			var maylenovo = new MayTinhLENOVO();
			maylenovo.ChieuDai = 120;
			maylenovo.ChieuRong = 300;
